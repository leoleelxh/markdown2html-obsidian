...
本项目基于原项目，做了以下修改：
1. 修改了图床设置，增加腾讯云等图床
2. 粘贴文档会自动上传外链、本地图片（还没充分测试） 
3. 增加插件，支持 Obsidian 一键排版和复制。使用方法：
   - 复制模式：点击工具栏的复制图标，或使用命令面板输入"复制当前文档到剪贴板"
   - 浏览器模式：点击工具栏的文档图标，或使用命令面板输入"在浏览器中打开当前文档"
   - 文档将在浏览器中打开
注意：粘贴文档会自动上传到配置好的图床。具体要分情况：
- 如果文档中包含本地图片，请使用插件的复制功能。会自动上传到图床，并替换为图床链接
- 如果文档中包含外部图片链接，则手动复制文档即可。使用插件的复制功能，不会触发替换链接
